...
import {
  createOllamaToolCallCompatFetch,
} from '../src/services/ollama-tool-call-compat-fetch.js';

test(
  'proteção de saída preserva a conversão de tool call textual do Ollama',
  async () => {
    let outboundBody = '';
