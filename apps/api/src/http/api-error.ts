...
export type ApiErrorCode =
  ...
  | 'MIGRATION_MUTATION_EXECUTION_UNAVAILABLE'
  ...
  | 'DEPENDENCIES_PTY_ALREADY_RUNNING'
  | 'DEPENDENCIES_PTY_RUNTIME_UNSUPPORTED'
