...
export const GIT_DIFF_BINARY_PREVIEW_LIMIT = 8 * 1024 * 1024;
export const GIT_DIFF_IMAGE_PREVIEW_LIMIT = GIT_DIFF_BINARY_PREVIEW_LIMIT;
...
export const REMOTE_UNAVAILABLE_PATTERN =
