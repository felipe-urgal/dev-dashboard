...
export function ensureTestPathInsideProject(projectPath: string, requested: string): string {
...
export function composeFileCommand(resolved: ResolvedCommand, filePath: string): ResolvedCommand {
