...
import { activityListResponseSchema, commonErrorResponseSchemas } from '../http/response-schemas.js';
...
export const activityRoutes: FastifyPluginAsync<Options> = async (app, options) => {
  app.get<{ Querystring: Query }>('/activities', {
    schema: {
      querystring: {
        type: 'object',
