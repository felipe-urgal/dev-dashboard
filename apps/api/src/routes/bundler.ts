...
import { bundlerOverviewResponseSchema, commonErrorResponseSchemas } from '../http/response-schemas.js';
...
export const bundlerRoutes: FastifyPluginAsync<Options> = async (app, options) => {
  app.get<{ Params: Params }>('/projects/:projectId/bundler', {
    schema: {
      params: paramsSchema,
      response: {
        200: {
          type: 'object', additionalProperties: false, required: ['bundler'],
