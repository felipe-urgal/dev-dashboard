...
const TEST_SCRIPT = /^(?:test|tests|spec|specs|vitest|jest|rspec|pytest)(?::|$)/;
const DATABASE_SCRIPT = /(?:^|:)(?:db:)?(?:migrate|migration|migrations|rollback)(?::|$)/;
...
export function isRunnableProjectScript(script: ProjectScript, project: Project): boolean {
