...
.git-diff-page-heading p:not([hidden]) {
  display: flex;
  flex-wrap: wrap;
  gap: 7px;
  margin: 0;
...
.git-diff-files-pane > header .git-diff-files-pane-actions {
  display: flex;
  align-items: center;
  gap: 10px;
}

.git-diff-collapse-button {
  display: inline-flex;
  align-items: center;
  gap: 5px;
  border: 1px solid var(--border);
...
.git-diff-collapse-button:hover {
  border-color: var(--border-strong);
  color: var(--text);
}

.git-diff-collapse-button svg {
  width: 15px;
  height: 15px;
}
...
.git-diff-resize-handle:hover,
.git-diff-resize-handle:focus-visible {
  background: var(--accent);
  outline: none;
}

.git-diff-workspace.is-resizing {
  user-select: none;
  cursor: col-resize;
}

.git-diff-workspace.is-resizing .git-diff-resize-handle {
  background: var(--accent);
}
