...
export function labelValue(parent: HTMLElement, label: string, value: string, className?: string): void {
...
export function updatePressed(button: HTMLButtonElement, active: boolean): void {
