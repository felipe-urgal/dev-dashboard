...
import type { ParsedTestFailure, ParsedTestReport, TestLogInspectorMode } from './types';
...
export function failureDetail(report: ParsedTestReport, failure: ParsedTestFailure, mode: TestLogInspectorMode): HTMLElement {
