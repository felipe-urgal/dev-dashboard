# Próxima atividade — 045: snapshot/restore de banco no painel
...
PR/MR composta sem chamar API de provedor). Após o ajuste pontual do cabeçalho
de detalhes (task 044), o próximo item do mesmo ponto do roadmap ainda
pendente é snapshot/restore de banco reconhecido: hoje
