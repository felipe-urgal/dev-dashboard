...
- `063-stop-servers-and-scripts-refactor.md` — corrige o falso timeout ao parar processos sem observador em memória e conclui a refatoração pura do `ProjectScriptsPanel.vue` na Fase 7.
