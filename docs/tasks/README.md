...
- `054-server-panel-cleanup.md` — simplificação da aba Servidor, removendo as prévias redundantes de atividade e logs, suas consultas específicas e reorganizando configuração e status em uma grade responsiva de dois cartões.
