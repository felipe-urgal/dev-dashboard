...
- `080-ollama-local-ai.md` — plano de IA local com Ollama: painel de chat contextual, ações rápidas, catálogo fechado de ferramentas e streaming cancelável, sempre intermediado pela API.
