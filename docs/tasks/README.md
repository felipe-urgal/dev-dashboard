...
- `083-ai-proposed-edits-plan.md` — plano detalhado (ainda não implementado) para a quinta ferramenta do assistente, `propose_workspace_edit`: reaproveita o preview/confirmação/rollback da task 077 sem rota nova para aplicar, com fluxo não-bloqueante em relação ao modelo.
