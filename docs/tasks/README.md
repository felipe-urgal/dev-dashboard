...
- `081-inline-completion.md` — plano de compleção inline (ghost text/FIM) com Ollama local, debounce, cancelamento agressivo e contexto semântico opt-in via embeddings.
